...
function requestJson(url, options = {}) {
  return new Promise((resolve, reject) => {
    ...
    if (options.body != null) {
      const contentType = String(requestOptions.headers['Content-Type'] || requestOptions.headers['content-type'] || '').toLowerCase();
      const shouldPassObjectBody = contentType.includes('application/json')
        && options.body
        && typeof options.body === 'object';

      requestOptions.body = shouldPassObjectBody
        ? options.body
